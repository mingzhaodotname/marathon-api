...
type AppAppContainerContainerPortMapping struct {
	...
	ContainerPort AppNumberAnyPort `json:"containerPort"`
	...
	// This can be used to add metadata to be interpreted by external applications such as firewalls.
	Labels AppLabelKvLabels `json:"labels,omitempty"`

	// Name of the service hosted on this port. If provided, it must be unique over all port mappings.
	...
	ServicePort AppNumberAnyPort `json:"servicePort,omitempty"`

	// List of the container networks associated with this mapping. If absent, then this mapping is associated with all defined container networks (for this application). A single item list is mandatory when `hostPort` is specified and multiple container networks are defined. 
